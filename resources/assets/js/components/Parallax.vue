  ...
  <div id="results" class="parallax">
    ...
    <div v-else class="content" :class="{ 'overflow-y-scroll': search }">
      <div v-if="!search" class="text-center">
        ...
        <img class="desk-disp" width="80%" style="max-width: 800px; margin:0 auto;"
          src="https://static.wixstatic.com/media/b258fc_524e497a8fd94c96bc704c826cfd9a9f~mv2.png/v1/fill/w_673,h_264,al_c,usm_0.66_1.00_0.01/b258fc_524e497a8fd94c96bc704c826cfd9a9f~mv2.png"
          alt="iccn_map">
        <hr>
        <div class="row">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-3 form-group">
                  <input @keyup.enter="searchFor()" v-model="nombre" type="text" class="form-control"
                    :placeholder="$t('form.placeholder.Search')">
                </div>
                <div class="col-md-3 form-group">
                  <div class="input-group">
                    <input :disabled="paises.length === 0" @keyup="searchPais" v-model="pais" type="text"
                      class="form-control" :placeholder="$t('form.placeholder.Country')">
                    <div class="input-group-prepend">
                      <button @click="listCountry" type="button" class="btn btn-primary"><i
                          class="fas fa-chevron-down"></i></button>
                    </div>
                  </div>
                  <transition name="fade">
                    <ul v-if="paises.length !== 0" class="input-results list-group">
                      <a @click="setPais(pais.id, pais.nombre)" v-for="pais in paises" role="button"
                        class="list-group-item list-group-item-action">{{ pais.nombre }}</a>
                    </ul>
                  </transition>
                </div>
                <div class="col-md-3 form-group">
                  <select class="form-control" v-model="categoria">
                    ...
                    <option v-for="categoria in categorias" :value="categoria.id">
                      {{ $t('categoria.' + categoria.nombre.replace(" ", "")) }}</option>
                  </select>
                </div>
                <div class="col-md-3 form-group">
      ...
      <div class="container" v-else>
        ...
        <div v-else>
          <button @click="home()" style="float:right" class="search-member-btn btn btn-danger"><i
          ...
          <div class="row" style="height: -webkit-fill-available; padding-top: 30px;">
            <div v-if="categoria !== 5" class="col-md-6 result-member" v-for="member in results">
              <div class="card"
                :class="{ conscard: member.categoria_id === 1, coachcard: member.categoria_id === 2, capacard: member.categoria_id === 3, empresacard: member.categoria_id === 4, programcard: member.categoria_id === 5, especial: member.categoria_id === 6 }">
                      ...
                      <div class="member">
                        <div class="mobile-member">
                          <div class="member-picture"
                            :style="'background: url(/storage/' + member.foto + ') center no-repeat'"></div>
                          <div class="member-flag"
                            :style="'background: url(/storage/flags/' + member.pais.id + '.png) center no-repeat'"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-9">
                        ...
                        <div class="col-md-12">
                          <div class="card-category">
                            ...
                            <img v-if="member.categoria_id === 1" width="40" src="/media/img/categorias/consultor.png"
                              alt="categoria_icon">
                            <img v-if="member.categoria_id === 2" width="40" src="/media/img/categorias/coach.png"
                              alt="categoria_icon">
                            <img v-if="member.categoria_id === 3" width="40" src="/media/img/categorias/capacitador.png"
                              alt="categoria_icon">
                            <img v-if="member.categoria_id === 4" width="40" src="/media/img/categorias/empresa.png"
                              alt="categoria_icon">
                            <img v-if="member.categoria_id === 5" width="40" src="/media/img/categorias/programas.png"
                              alt="categoria_icon">
                            <img v-if="member.categoria_id === 6" width="40"
                              src="/media/img/categorias/certificaciones_especializadas.png" alt="categoria_icon">
                          </div>
                          <h3>{{ member.name }} {{ member.apellido_p ? member.apellido_p : '' + ' ' + member.apellido_m ?
                            member.apellido_m : '' }}</h3>
                        </div>
                      </div>
                      <a v-if="member.fb" :href="'https://facebook.com/' + member.fb"><img width="30"
                          src="/media/img/recursos/fb-logo.png" alt="facebook logo"></a>


                      <a v-if="member.tw" :href="'https://twitter.com/' + member.tw"><img width="30"
                          src="/media/img/recursos/tw-logo.png" alt="facebook logo"></a>


                      <a v-if="member.in" :href="'https://linkedin.com/' + member.in"><img width="30"
                          src="/media/img/recursos/in-logo.png" alt="facebook logo"></a>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="member">
                        <div class="mobile-member">
                          <div class="member-picture"
                            :style="'background: url(/storage/' + program.foto + ') center no-repeat'"></div>
                          <div class="member-flag"
                            :style="'background: url(/storage/flags/' + program.empresa.pais.id + '.png) center no-repeat'">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-9">
                      ...
                      <a v-if="program.empresa.fb" :href="'https://facebook.com/' + program.empresa.fb"><img width="30"
                          src="/media/img/recursos/fb-logo.png" alt="facebook logo"></a>


                      <a v-if="program.empresa.tw" :href="'https://twitter.com/' + program.empresa.tw"><img width="30"
                          src="/media/img/recursos/tw-logo.png" alt="facebook logo"></a>


                      <a v-if="program.empresa.in" :href="'https://linkedin.com/' + program.empresa.in"><img width="30"
                          src="/media/img/recursos/in-logo.png" alt="facebook logo"></a>
