              ...
              <div class="row">
                ...
                <div class="col-md-3 form-group">
                  ...
                  <transition name="fade">
                    <ul
                      ...
                      class="input-results list-group"
                    >
                      <a
                ...
                <div class="col-md-3 form-group">
                  <select class="form-control" v-model="categoria">
                    ...
                    >
                      {{
                        $t("categoria." + categoria.nombre.replace(" ", ""))
                      }}</option
                    >
                  </select>
                </div>
                <div class="col-md-3 form-group">
                  <button @click="searchFor()" class="btn btn-primary">
      ...
      <div class="container" v-else>
        ...
        <div v-else>
          <button
            @click="home()"
            style="float:right"
            class="search-member-btn btn btn-danger"
          >
            <i class="fas fa-home"></i>
          </button>
          <div
            class="row"
            style="height: -webkit-fill-available; padding-top: 30px;"
          >
            <div
              v-if="categoria !== 5"
              class="col-md-6 result-member"
              v-for="member in results"
            >
              <div
                class="card"
                :class="{
                  conscard: member.categoria_id === 1,
                  coachcard: member.categoria_id === 2,
                  capacard: member.categoria_id === 3,
                  empresacard: member.categoria_id === 4,
                  programcard: member.categoria_id === 5,
                  especial: member.categoria_id === 6,
                }"
              >
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="card-category">
                            <span v-if="member.categoria_id === 1">{{
                              $t("categoria.Consultor")
                            }}</span>
                            <span v-if="member.categoria_id === 2">{{
                              $t("categoria.Coach")
                            }}</span>
                            <span v-if="member.categoria_id === 3">{{
                              $t("categoria.Capacitador")
                            }}</span>
                            <span v-if="member.categoria_id === 4">{{
                              $t("categoria.Empresa")
                            }}</span>
                            <span v-if="member.categoria_id === 5">{{
                              $t("categoria.Programa")
                            }}</span>
                            <span v-if="member.categoria_id === 6">{{
                              $t("categoria.CertificacionesEspecializadas")
                            }}</span>
                            &nbsp;&nbsp;&nbsp;
                            <img
                              v-if="member.categoria_id === 1"
                              width="40"
                              src="/media/img/categorias/consultor.png"
                              alt="categoria_icon"
                            />
                            <img
                              v-if="member.categoria_id === 2"
                              width="40"
                              src="/media/img/categorias/coach.png"
                              alt="categoria_icon"
                            />
                            <img
                              v-if="member.categoria_id === 3"
                              width="40"
                              src="/media/img/categorias/capacitador.png"
                              alt="categoria_icon"
                            />
                            <img
                              v-if="member.categoria_id === 4"
                              width="40"
                              src="/media/img/categorias/empresa.png"
                              alt="categoria_icon"
                            />
                            <img
                              v-if="member.categoria_id === 5"
                              width="40"
                              src="/media/img/categorias/programas.png"
                              alt="categoria_icon"
                            />
                            <img
                              v-if="member.categoria_id === 6"
                              width="40"
                      ...
                      <a
                        v-if="member.fb"
                        :href="'https://facebook.com/' + member.fb"
                        ><img
                          width="30"
                      ...
                      <a
                        v-if="member.in"
                        :href="'https://linkedin.com/' + member.in"
                        ><img
                          width="30"
                ...
                <div class="card-body">
                  <div class="card-text text-center table-responsive">
                    ...
                    <a
                      v-if="member.categoria_id !== 4"
                      class="btn btn-primary"
                      :href="'/perfil/' + member.user.folio + '/' + member.slug"
                ...
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <a
                        v-if="program.empresa.fb"
                        :href="'https://facebook.com/' + program.empresa.fb"
                        ><img
                          width="30"
                          src="/media/img/recursos/fb-logo.png"
                          alt="facebook logo"
                      ...
                      <a
                        v-if="program.empresa.tw"
                        :href="'https://twitter.com/' + program.empresa.tw"
                        ><img
                          width="30"
                          src="/media/img/recursos/tw-logo.png"
                          alt="twitter logo"
                      ...
                      <a
                        v-if="program.empresa.in"
                        :href="'https://linkedin.com/' + program.empresa.in"
                        ><img
                          width="30"
                          src="/media/img/recursos/in-logo.png"
                          alt="linkedin logo"
                      ...
                      <a
                        ...
                        :href="'https://instagram.com/' + program.empresa.insta"
                        ><img
                          width="30"
                          src="/media/img/recursos/in-logo.png"
                          alt="instagram logo"
