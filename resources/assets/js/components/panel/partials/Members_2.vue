    ...
    <div class="col-lg-12">
        ...
        <div class="col-sm-6">
          <div class="btn-group" role="group" aria-label="Basic example">
            <button
              ...
              class="btn"
              :class="{ 'btn-primary': !empresa, 'btn-dark': empresa }"
            >
              Miembros
            </button>
            <button
        ...
        <div class="col-sm-6">
          <div class="input-group">
            ...
            <div class="input-group-prepend">
              ...
              <button
                @click="$bus.$emit('registerModal', { sw: empresa, admin: 1 })"
                class="btn btn-link"
              >
        ...
        <li class="list-group-item">
          <div class="row">
            ...
            >
              <div class="user-card">
                <button
                  @click="deleteUser(user.user.id, index, 'user')"
                ...
                <transition name="fade">
                  <div
                    v-if="expertise === magic + '_exp_' + index"
                    class="skillsEdit"
                  >
                    <div class="row">
                      <div class="col">
                        <h1>
                          Areas de expertise
                          <button
                            @click="expertise = null"
                            class="close right-30 white"
                          >
                        ...
                        <div>
                          <div
                            v-if="newVal !== 'newVal_' + index"
                            v-for="(valoracion, index2) in user.user.valoracion"
                            class="row editvalorations"
                          >
                            <div class="col-4">
                              <span
                                @click="editVal(index, valoracion.id, 1)"
                                v-if="
                                  valoration !==
                                    'val_' + index + '_' + valoracion.id
                                "
                                :id="'val_' + index + '_' + magic"
                                >{{ valoracion.area }}</span
                              >
                              <div
                                v-if="
                                  valoration ===
                              ...
                              >
                                <input
                                  ref="valoration"
                                  @keyup.esc="editVal(index, valoracion.id, 0)"
                                  @keyup.enter="
                                    updateVal(
                                      valoracion.id,
                                      'name',
                                  ...
                                  "
                                  :id="'valInput_' + valoracion.id"
                                  maxlength="30"
                                  style="margin-bottom: 10px"
                                  type="text"
                                  class="form-control"
                                  :value="valoracion.area"
                                />
                            ...
                            <div class="col-8 text-left">
                              ...
                              >
                                <span
                                  v-for="val in parseInt(valoracion.porcentaje)"
                              ...
                              >
                                <span
                                  ...
                                  "
                                  :id="'staram_' + index3 + '_' + valoracion.id"
                                  @mouseover="
                                    setlevel('a', index3, 1, valoracion.id)
                                  "
                                  @mouseout="
                                    setlevel('a', index3, 0, valoracion.id)
                                  "
                                  v-for="(star, index3) in 10"
                                  ><i class="fas fa-star"></i>&nbsp;&nbsp;</span
                                >
                              </span>
                              <button
                                @click="deleteVal(valoracion.id, index2, index)"
                                class="btn btn-link right danger"
                              >
                          ...
                          >
                            <button
                              @click="newVal = 'newVal_' + index"
                              v-if="user.user.valoracion.length < 5"
                              class="btn btn-link"
                            >
                              <i class="fas fa-plus"></i>
                            </button>
                          ...
                          <div class="container">
                            ...
                            >
                              <div class="col-12">
                                <div class="input-group">
                                  <input
                                    @keyup.enter="saveVal(index, user.user_id)"
                                    @keyup.esc="newVal = ''"
                                    :id="'newValInput_' + index"
                                    maxlength="40"
                                    style="margin-bottom: 10px"
                                    type="text"
                                    class="form-control"
                              ...
                              <div class="col-12">
                                ...
                                <span class="reg-stars">
                                  <span
                                    @click="newStars = indexs"
                                    :id="'newStaram_' + indexs"
                                    @mouseover="setleveln('a', indexs, 1)"
                                    @mouseout="setleveln('a', indexs, 0)"
                                    v-for="(star, indexs) in 10"
                                ...
                                <div>
                                  ...
                                  <button
                                    @click="saveVal(index, user.user_id)"
                                    class="btn btn-link"
                                  >
                                    <i class="fas fa-check success success"></i>
                                  </button>
                                </div>
                              </div>
                            </div>
                ...
                <div class="row" style="border-bottom: none">
                    ...
                    <div class="row">
                      <div class="col" style="height: 151px;">
                        <div class="panel-member-pic">
                          ...
                          ></div>
                          <div
                            v-if="editPic === magic + '_' + index"
                            style="position: absolute; right: 0; bottom: 0; height: auto;"
                          >
                            <button
                              @click="editUser(index, 0, 'pic')"
                              class="btn btn-light"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateUser(user.user_id, index, 'pic')"
                              class="btn btn-light"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                    ...
                    <div class="row">
                      <div @click="editUser(index, 1, 'name')" class="col">
                        ...
                        <div class="wedit" :id="'inputMname_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editUser(index, 0, 'name')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateUser(user.user_id, index, 'name')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                  ...
                  <div class="col-9">
                    <div
                      v-if="
                        editMemb !== magic + '_' + index &&
                          editCat !== magic + '_' + index
                      "
                      class="row"
                    >
                      <div class="col">
                        <b>Status:</b><br />
                        <button
                          @click="setStatus(user.user.id, index)"
                          class="btn btn-link"
                          :class="{
                            success: user.status,
                            danger: !user.status,
                      ...
                      <div @click="editUser(index, 1, 'folio')" class="col">
                        <span :id="'spanMfolio_' + index"
                          ><b>Folio: </b> <br />{{ user.user.folio }}</span
                        >

                        <div class="wedit" :id="'inputMfolio_' + index">
                          <input
                            :value="user.user.folio"
                            type="text"
                            class="form-control"
                          />
                          <div class="edit-btns">
                            <button
                              @click="editUser(index, 0, 'folio')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateUser(user.user_id, index, 'folio')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                      ...
                      <div
                        @click="editUser(index, 1, 'rango')"
                        class="col text-center"
                      >
                        <img
                          width="40%"
                          :src="'/media/img/medallas/' + user.rango + '.png'"
                          alt="membresia icon"
                        />
                      </div>
                      <div
                        @click="editUser(index, 1, 'cat')"
                        class="col text-center"
                      >
                        <img
                          v-for="categoria in user.user.categorias"
                          width="30%"
                          v-if="categoria.categoria_id !== 5"
                          :src="
                    ...
                    <div v-if="editMemb === magic + '_' + index" class="row">
                      <div class="col text-center membresias">
                        <img
                          @click="
                            updateUser(user.user_id, index, 'rango', 'afiliado')
                          "
                          :class="{ selected: user.rango === 'afiliado' }"
                          width="15%"
                        ...
                        <img
                          ...
                          "
                          :class="{ selected: user.rango === 'especialista' }"
                          width="15%"
                        ...
                        <img
                          @click="
                            updateUser(user.user_id, index, 'rango', 'experto')
                          "
                          :class="{ selected: user.rango === 'experto' }"
                          width="15%"
                        ...
                        <img
                          ...
                          "
                          :class="{ selected: user.rango === 'profesional' }"
                          width="15%"
                    ...
                    <div v-if="editCat === magic + '_' + index" class="row">
                      <div class="col text-center membresias">
                        <span v-for="(categoria, index) in userCats">
                          <img
                            @click="setCat({ categoria_id: 1 }, 0)"
                            class="selected"
                            v-if="categoria.categoria_id === 1"
                            width="15%"
                            src="/media/img/categorias/consultor.png"
                            alt="membresia icon"
                          />&nbsp;&nbsp;&nbsp;
                          <img
                            @click="setCat({ categoria_id: 2 }, 0)"
                            class="selected"
                            v-if="categoria.categoria_id === 2"
                            width="15%"
                            src="/media/img/categorias/coach.png"
                            alt="membresia icon"
                          />&nbsp;&nbsp;&nbsp;
                          <img
                            @click="setCat({ categoria_id: 3 }, 0)"
                            class="selected"
                            v-if="categoria.categoria_id === 3"
                            width="15%"
                            src="/media/img/categorias/capacitador.png"
                            alt="membresia icon"
                          />&nbsp;&nbsp;&nbsp;
                        </span>
                        ...
                        <span v-for="cat in categorias">
                          <img
                            v-if="cat.categoria_id === 1 || cat === 1"
                            @click="setCat({ categoria_id: 1 }, 1)"
                            width="15%"
                            src="/media/img/categorias/consultor.png"
                            alt="membresia icon"
                          />&nbsp;&nbsp;&nbsp;
                          <img
                            v-if="cat.categoria_id === 2 || cat === 2"
                            @click="setCat({ categoria_id: 2 }, 1)"
                            width="15%"
                            src="/media/img/categorias/coach.png"
                            alt="membresia icon"
                          />&nbsp;&nbsp;&nbsp;
                          <img
                            v-if="cat.categoria_id === 3 || cat === 3"
                            @click="setCat({ categoria_id: 3 }, 1)"
                            width="15%"
                            src="/media/img/categorias/capacitador.png"
                            alt="membresia icon"
                          />&nbsp;&nbsp;&nbsp;
                        ...
                        <span
                          style="float: right; padding: 10px;"
                          @click="updateUser(user.user_id, index, 'cat')"
                          ><i class="fas fa-check success success"></i
                        ></span>
                      </div>
                    </div>
                    <div v-if="editAp !== magic + '_' + index" class="row">
                      ...
                      <div @click="editUser(index, 1, 'tel')" class="col">
                        ...
                        <div class="wedit" :id="'inputMtel_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editUser(index, 0, 'tel')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateUser(user.user_id, index, 'tel')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                      ...
                      <div @click="editUser(index, 1, 'cel')" class="col">
                        ...
                        <div class="wedit" :id="'inputMcel_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editUser(index, 0, 'cel')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateUser(user.user_id, index, 'cel')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                    ...
                    <div v-if="editAp === magic + '_' + index" class="row">
                      <div class="col">
                        ...
                        >
                          ...
                          <div class="input-group-prepend">
                            <button
                              @click="updateUser(user.user_id, index, magic)"
                              class="btn btn-link"
                            >
                    ...
                    <div v-if="editsocial !== magic + '_' + index" class="row">
                      ...
                      <div @click="editUser(index, 1, 'in')" class="col">
                        <span :id="'spanMin_' + index"
                          ><b>Linkedin: </b><br />{{
                            user.in ? user.in : "-"
                          }}</span
                        >
                      </div>
                      <div @click="editUser(index, 1, 'insta')" class="col">
                        <span :id="'spanMinsta_' + index"
                          ><b>Instagram: </b><br />{{
                    ...
                    <div v-if="editsocial === magic + '_' + index" class="row">
                      <div class="col social-input">
                        ...
                        <span v-if="magic === 'insta'">www.instagram.com/</span>
                        <div
                          class="input-group"
                          :id="'inputM' + magic + '_' + index"
                        >
                ...
                <div class="row">
                  <div
                    v-if="editI !== magic + '_' + index"
                    @click="editUser(index, 1, 'web')"
                    class="col"
                  >
                    ...
                    <div class="wedit" :id="'inputMweb_' + index">
                      ...
                      <div class="edit-btns">
                        <button
                          @click="editUser(index, 0, 'web')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                        <button
                          @click="updateUser(user.user_id, index, 'web')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  >
                    ...
                    <div class="wedit" :id="'inputMpais_' + index">
                      ...
                      <div class="edit-btns">
                        <button
                          @click="editUser(index, 0, 'pais')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                        <button
                          @click="updateUser(user.user_id, index, 'pais')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  >
                    ...
                    <div class="wedit" :id="'inputMcd_' + index">
                      ...
                      <div class="edit-btns">
                        <button
                          @click="editUser(index, 0, 'cd')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                        <button
                          @click="updateUser(user.user_id, index, 'cd')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  <div class="col" :class="{ overflowv: idiomasResults }">
                    <div v-if="editI === magic + '_' + index">
                      <span
                        @click="setLang(index, idioma.nombre, 0)"
                        class="user-lang del-idioma"
                        v-for="(idioma, index) in idiomas"
                        ><b><i class="fas fa-times danger"></i></b>
                        {{ idioma }}</span
                      >
                      <div class="input-group">
                        <input
                        ...
                        />
                        <div class="input-group-prepend">
                          <button @click="editI = false" class="btn btn-link">
                            <i class="fas fa-times danger"></i>
                          </button>
                        </div>
                        <div class="input-group-prepend">
                          <button
                            @click="updateUser(user.user_id, index, 'idiomas')"
                            class="btn btn-link"
                          >
                            <i class="fas fa-check success"></i>
                          </button>
                      ...
                      <transition name="fade">
                        <ul
                          v-if="idiomasResults.length !== 0 && idioma !== ''"
                          class="list-group input-results"
                        >
                          <a
                            @click="setLang(index, idioma.nombre, 1)"
                            href="#"
                            role="button"
                            class="list-group-item list-group-item-action"
                            v-for="idioma in idiomasResults"
                            >{{ idioma.nombre }}</a
                          >
                        </ul>
                      </transition>
                    ...
                    <span
                      @click="editUser(index, 1, 'idiomas')"
                      v-if="editI !== 'idiomas_' + index"
                    >
                ...
                <div v-if="editCred === magic + '_' + index" class="row">
                  <div v-if="magic === 'email'" class="col social-input">
                    ...
                    >
                      ...
                      <div class="input-group-prepend">
                        <button
                          @click="updateUser(user.user_id, index, 'email')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  <div v-if="magic === 'pass'" class="col social-input">
                    ...
                    >
                      ...
                      <div class="input-group-prepend">
                        <button
                          @click="updateUser(user.user_id, index, 'pass')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
      ...
      <ul v-else class="list-group panel-list">
        ...
        <li class="list-group-item">
          <div class="row">
            <div
              v-for="(user, index) in empresas"
              class="col-xl-4"
              style="padding:30px; text-align: center;"
            >
              <div class="user-card">
                <button
                  @click="deleteUser(user.user.id, index, 'empresa')"
                  class="btn btn-danger btn-delete"
                >
                  <i class="fas fa-trash"></i>
                </button>
                ...
                <div class="row" style="border-bottom: none">
                    ...
                    <div class="row">
                      <div class="col" style="height: 151px;">
                        <div class="panel-member-pic">
                          ...
                          >
                            <button
                              @click="editEmpresa(index, 0, 'pic')"
                              class="btn btn-light"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateEmpresa(user.user_id, index, 'pic')"
                              class="btn btn-light"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                          ...
                          <input
                            @change="fileChangem($event, index)"
                            :id="'fileInput_' + index"
                            type="file"
                            class="hidden"
                          />
                    ...
                    <div class="row">
                      <div @click="editEmpresa(index, 1, 'folio')" class="col">
                        ...
                        <div class="wedit" :id="'inputEfolio_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editEmpresa(index, 0, 'folio')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="
                                updateEmpresa(user.user_id, index, 'folio')
                              "
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                  ...
                  <div class="col-9">
                    <div v-if="editMemb !== magic + '_' + index" class="row">
                      ...
                      <div
                        @click="editEmpresa(index, 1, 'rango')"
                        class="col text-center"
                      >
                        <img
                          width="40%"
                      ...
                      <div
                        @click="editEmpresa(index, 1, 'cat')"
                        class="col text-center"
                      >
                        <img
                          width="40%"
                          src="/media/img/categorias/empresa.png"
                          alt="user cat"
                        />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div @click="editEmpresa(index, 1, 'name')" class="col">
                        ...
                        <div class="wedit" :id="'inputEname_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editEmpresa(index, 0, 'name')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="
                                updateEmpresa(user.user_id, index, 'name')
                              "
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                      ...
                      <div @click="editEmpresa(index, 1, 'tel')" class="col">
                        ...
                        <div class="wedit" :id="'inputEtel_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editEmpresa(index, 0, 'tel')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateEmpresa(user.user_id, index, 'tel')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                      ...
                      <div @click="editEmpresa(index, 1, 'web')" class="col">
                        ...
                        <div class="wedit" :id="'inputEweb_' + index">
                          ...
                          <div class="edit-btns">
                            <button
                              @click="editEmpresa(index, 0, 'web')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                            <button
                              @click="updateEmpresa(user.user_id, index, 'web')"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success success"></i>
                            </button>
                    ...
                    <div v-if="editsocial !== magic + '_' + index" class="row">
                      <div @click="editEmpresa(index, 1, 'fb')" class="col">
                        <span :id="'spanEfb_' + index"
                          ><b>Facebook: </b><br />{{ user.fb }}</span
                        >
                      </div>
                      <div @click="editEmpresa(index, 1, 'tw')" class="col">
                        <span :id="'spanEtw_' + index"
                          ><b>Twitter: </b><br />{{ user.tw }}</span
                        >
                      </div>
                      <div @click="editEmpresa(index, 1, 'in')" class="col">
                        <span :id="'spanEin_' + index"
                          ><b>Linkedin: </b><br />{{ user.in }}</span
                        >
                      </div>
                      <div @click="editEmpresa(index, 1, 'insta')" class="col">
                        <span :id="'spanEinsta_' + index"
                          ><b>Linkedin: </b><br />{{ user.insta }}</span
                        >
                      </div>
                    </div>
                    <div v-if="editsocial === magic + '_' + index" class="row">
                      <div class="col social-input">
                        ...
                        >
                          ...
                          <div class="input-group-prepend">
                            <button
                              @click="editEmpresa(index, 0, magic)"
                              class="btn btn-link"
                            >
                              <i class="fas fa-times danger"></i>
                            </button>
                          ...
                          <div class="input-group-prepend">
                            <button
                              @click="updateEmpresa(user.user_id, index, magic)"
                              class="btn btn-link"
                            >
                              <i class="fas fa-check success"></i>
                            </button>
                ...
                <div v-if="editCred !== magic + '_' + index" class="row">
                  ...
                  <div class="col-3">
                    <span
                      @click="editEmpresa(index, 1, 'pass')"
                      :id="'spanEpass_' + index"
                      ><b>Password: </b><br />{{
                        user.user.password ? user.user.password : "******"
                      }}</span
                ...
                <div v-if="editCred === magic + '_' + index" class="row">
                  <div v-if="magic === 'email'" class="col social-input">
                    ...
                    >
                      ...
                      <div class="input-group-prepend">
                        <button
                          @click="editEmpresa(index, 0, 'email')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                      ...
                      <div class="input-group-prepend">
                        <button
                          @click="updateEmpresa(user.user_id, index, 'email')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  <div v-if="magic === 'pass'" class="col social-input">
                    ...
                    >
                      ...
                      <div class="input-group-prepend">
                        <button
                          @click="editEmpresa(index, 0, 'pass')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                      ...
                      <div class="input-group-prepend">
                        <button
                          @click="updateEmpresa(user.user_id, index, 'pass')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                ...
                <div class="row">
                  <div
                    v-if="editI !== magic + '_' + index"
                    @click="editEmpresa(index, 1, 'pais')"
                    class="col"
                  >
                    ...
                    <div class="wedit" :id="'inputEpais_' + index">
                      ...
                      <div class="edit-btns">
                        <button
                          @click="editEmpresa(index, 0, 'pais')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                        <button
                          @click="updateEmpresa(user.user_id, index, 'pais')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  >
                    ...
                    <div class="wedit" :id="'inputEcd_' + index">
                      ...
                      <div class="edit-btns">
                        <button
                          @click="editEmpresa(index, 0, 'cd')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-times danger"></i>
                        </button>
                        <button
                          @click="updateEmpresa(user.user_id, index, 'cd')"
                          class="btn btn-link"
                        >
                          <i class="fas fa-check success success"></i>
                        </button>
                  ...
                  <div class="col" :class="{ overflowv: idiomasResults }">
                    <div v-if="editI === magic + '_' + index">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-prepend">
                          <button
                            @click="
                              updateEmpresa(user.user_id, index, 'idiomas')
                            "
                            class="btn btn-link"
                          >
                            <i class="fas fa-check success"></i>
                    ...
                    <span
                      @click="editEmpresa(index, 1, 'idiomas')"
                      v-if="editI !== 'idiomas_' + index"
                    >
                      <b>Idiomas: </b><br />{{ JSON.parse(user.idiomas) }}
                    </span>
...
export default {
  ...
  methods: {
    ...
    searchMember() {
      ...
      if (this.search !== "") {
        if (!this.empresa) {
          this.users = [];
          axios
            .post("/search-members", { nombre: this.search, magic: "2" })
            .then(function(users) {
              este.users = users.data;
            });
        } else {
          this.empresas = [];
          axios
            .post("/search-empresas", { nombre: this.search })
    ...
    editUser(index, sw, magic) {
      ...
      if (sw === 1) {
        ...
        if (magic === "pic") {
          ...
          $("#previewM_" + index).css(
            "background",
            "url(/storage/" + this.bkpic + ")center no-repeat"
          );
          this.picture = null;
        }
        setTimeout(function() {
    ...
    searchIdioma() {
      ...
      if (this.idioma !== "") {
        axios
          .post("/search-idioma", { idioma: this.idioma })
    ...
    updateVal(id, magic, user, index) {
      ...
      var este = this;
      axios
        .post("/panel/update-val", { id: id, name: nombre, magic: magic })
        .then(function(response) {
          if (!este.empresa) {
            este.users[user].user.valoracion[index] = response.data;
          } else {
    ...
    saveVal(index, id) {
      ...
      var este = this;
      axios
        .post("/panel/add-valoration/" + id, { area: area, percent: percent })
        .then(function(response) {
          if (!este.empresa) {
