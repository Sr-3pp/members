  ...
  <div class="modal-content">
    ...
    <div class="modal-header">
      <h5 v-if="!admin" class="modal-title" id="exampleModalLabel">
        ...
        <small
          >(Recuerda que tu perfil estará en línea hasta realizar el pago de tu
          membresía.)</small
        >
      </h5>
    ...
    <div class="modal-body">
      ...
      <form>
        <div class="row">
          <div class="col-sm-4 mb-20">
            <transition name="fade">
              <span v-if="alertName" class="must"
        ...
        <div class="row">
          <div class="col-sm-4 mb-20">
            <transition name="fade">
              <span v-if="alertMemb" class="must"
                >Este campo es obligatorio</span
              >
            </transition>
          ...
          <div class="col-sm-4 mb-20">
            <transition name="fade">
              <span v-if="alertPais" class="must"
                >Este campo es obligatorio</span
              >
            </transition>
        ...
        <div class="row">
          <div class="col-sm-4 mb-20">
            <transition name="fade">
              <span v-if="alertPaisr" class="must"
                >Este campo es obligatorio</span
              >
            </transition>
          ...
          <div class="col-sm-4 mb-20">
            <div class="input-group">
              ...
              <div class="input-group-prepend">
                <button @click="listLang" type="button" class="btn btn-default">
            ...
            <transition name="fade">
              <ul
                v-if="languajes.length !== 0"
                class="list-group input-results"
              >
                <a
                  @click="setLang(languaje.nombre)"
                  href="#"
                  role="button"
                  class="list-group-item list-group-item-action"
                  v-for="languaje in languajes"
                  >{{ languaje.nombre }}</a
                >
              </ul>
            </transition>
            ...
            <div class="col-sm-4">
              <ul class="languajes">
                <li v-for="idioma in idiomas">
                  <span @click="delIdioma(idioma)" class="badge del-idioma"
      ...
      <div class="row catSelector">
        <div class="col-sm-4 text-center">
          <transition name="fade">
            <span v-if="alertCats" class="must"
              >Selecciona almenos una categoría</span
            >
          </transition>
          <img
            :class="{ activeCat: consultor }"
            @click="consultor ? (consultor = false) : (consultor = true)"
            width="90"
        ...
        <div class="col-sm-4 text-center">
          <img
            :class="{ activeCat: coach }"
            @click="coach ? (coach = false) : (coach = true)"
            width="90"
        ...
        <div class="col-sm-4 text-center">
          <img
            :class="{ activeCat: capacitador }"
            @click="capacitador ? (capacitador = false) : (capacitador = true)"
            width="90"
        ...
        <div class="col-sm-4 text-center">
          <img
            :class="{ activeCat: especialidad }"
            @click="
              especialidad ? (especialidad = false) : (especialidad = true)
            "
            width="90"
        ...
        <div class="col-sm-4 text-center">
          ...
          <span class="reg-stars">
            <span
              @click="level('a', index)"
              :id="'staram_' + index"
              @mouseover="setlevel('a', index, 1)"
              @mouseout="setlevel('a', index, 0)"
        ...
        <div class="col-sm-4">
          ...
          <span class="reg-stars" v-if="area1 !== '' && area1v !== 0">
            <span
              @click="level('b', index)"
              :id="'starbm_' + index"
              @mouseover="setlevel('b', index, 1)"
              @mouseout="setlevel('b', index, 0)"
              v-for="(star, index) in 10"
              ><i class="fas fa-star"></i>&nbsp;&nbsp;</span
            >
          </span>
          <span class="reg-stars" v-else>
            <span v-for="(star, index) in 10"
              ><i class="fas fa-star"></i>&nbsp;&nbsp;</span
            >
          </span>
        </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          ...
          <span
            class="reg-stars"
            v-if="area1 !== '' && area1v !== 0 && area2 !== '' && area2v !== 0"
          >
            <span
              @click="level('c', index)"
              :id="'starcm_' + index"
              @mouseover="setlevel('c', index, 1)"
              @mouseout="setlevel('c', index, 0)"
              v-for="(star, index) in 10"
              ><i class="fas fa-star"></i>&nbsp;&nbsp;</span
            >
          </span>
        ...
        <div class="col-sm-4">
          ...
          >
            <span
              @click="level('d', index)"
              :id="'stardm_' + index"
              @mouseover="setlevel('d', index, 1)"
              @mouseout="setlevel('d', index, 0)"
              v-for="(star, index) in 10"
              ><i class="fas fa-star"></i>&nbsp;&nbsp;</span
            >
          </span>
        ...
        <div class="col-sm-4">
          ...
          >
            <span
              @click="level('e', index)"
              :id="'starem_' + index"
              @mouseover="setlevel('e', index, 1)"
              @mouseout="setlevel('e', index, 0)"
              v-for="(star, index) in 10"
              ><i class="fas fa-star"></i>&nbsp;&nbsp;</span
            >
          </span>
      ...
      <div class="row">
        <div class="col-md-8 mb-20">
          ...
          <div class="row">
            <div class="col">
              <transition name="fade">
                <span v-if="alertConfirm" class="must"
                  >Este campo es obligatorio</span
                >
              </transition>
              <input
      ...
      if (
        ...
        if (this.password === this.confirm) {
          ...
          if (
            ...
            console.log("el insta", this.insta);
