        ...
        <div class="row" style="height:100%; margin: 0 auto;" :class="{plusWidth : selected}">
          <div v-if="selected" class="col-md-12 text-right">
            ...
            <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col" style="position: relative">
                      ...
                      <transition name="fade">
                        <ul v-if="searchCountry" class="country-results list-group">
              ...
              <transition name="fade">
                <div v-if="selected" class="row" :style="active">
                  <div class="col-md-6" v-for="member in members">
                          ...
                          <div class="col-sm-9 text-right">
                            <div class="row">
                              <div class="col-md-10" style="padding-top:3px;">
                                <h3>{{member.name+' '+member.apellido_p+' '+member.apellido_m}}</h3>
                              </div>
                              <div class="col-md-2">
                            ...
                            {{member.categoria['nombre']}} <br>
                            <a v-if="member.perfil.fb" :href="member.perfil.fb"><img width="30" src="/media/img/recursos/fb-logo.png" alt="facebook logo"></a>
                            <a v-if="member.perfil.tw" :href="member.perfil.tw"><img width="30" src="/media/img/recursos/tw-logo.png" alt="facebook logo"></a>
                            <a v-if="member.perfil.in" :href="member.perfil.in"><img width="30" src="/media/img/recursos/in-logo.png" alt="facebook logo"></a>
                          </div>
                        </div>
                      </div>
                      <div class="card-body">
                        <div class="card-text text-center">
                          <table class="table">
                            ...
                            <tr>
                              ...
                              <td class="text-left">{{member.rango}}</td>
                            </tr>
                            <tr>
