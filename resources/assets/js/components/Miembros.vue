<template>
    <div id="memberSection" class="container-fluid center-content" style="min-height:600px; position: relative;" :class="{activated : selected}">
        <div class="row" style="margin: 0 auto; width:100%" :class="{plusWidth : selected}">
          <div v-if="selected" class="membersBackBtn">
            ...
            <div class="col-md-12 no-padding">
              ...
              <transition-group name="fade">
                ...
                <div v-if="selected && selected !== 5 && members[0]" id="memberCards" class="row mob-width" :style="active" key="1">
                  <template v-for="(member, i) in members">
                    <div v-if="member.perfil && member.perfil.status == 1 || member.empresa && member.empresa.status == 1" class="col-lg-6" :key="i">
                      <div class="card" :class="{conscard: consultor, coachcard: coach, capacard: capacitador, empresacard: empresa, programcard: programa, especial: certificacion}">
                              ...
                              <div class="row">
                                <div class="col-md-12" style="padding-top:3px;">
                                  <div class="card-category">
                                        ...
                                        <span v-if="selected === 6">{{$t('categoria.CertificacionesEspecializadas')}}</span>
                                        &nbsp;&nbsp;&nbsp;
                                        ...
                                        <img v-if="selected === 6" width="40" src="/media/img/categorias/certificaciones_especializadas.png" alt="categoria_icon">
                                  </div>
                ...
                <div v-else-if="selected && selected !== 5 && !members[0]" id="memberCards" class="row mob-width no-members" key="1">
                  <h2>
                    No se encontraron resultados.
                  </h2>
                </div>
                <div v-else-if="selected && selected === 5" key="2" id="memberCards" class="row" :style="active">
                  <div v-if="program.status === 1" class="col-md-6" v-for="program in programs" :key="program.name">
                ...
                <ul class="category-list" :class="{fixedCat : selected}">
                  ...
                  <li @click="setSelection(5)">
                    <img name="cat" src="/media/img/categorias/programa.png" alt="programa_icon"> <br>
                    Programas
                  </li>
                  <li @click="setSelection(6)">
                    <img name="cat" src="/media/img/categorias/certificaciones_especializadas.png" alt="programa_icon"> <br>
